...
pacman::p_load(geodata, terra, leaflet, mapview, leafsync, here)
```
...
# url <- "https://raw.githubusercontent.com/UCLouvain-GEOG/LGEO2185/main/Geoprojects/data/raw/occurrence_data.Rds"
# tmp <- tempfile(fileext = ".rds")
# download.file(url, tmp, mode = "wb")
# occurrence_df <- readRDS(tmp)
occurrence_df <- readRDS("data/raw/occurrence_data.Rds")
