---
title: "LGEO2185: Designing a Geoproject -- part 2"
...
Such model can be easily constructed based a database with observations and predictor variables. Let's see how we could do this by exploring the following `data.frame` You can download the data manually from here [Download the dataset (RDS)](https://raw.githubusercontent.com/ORG/REPO/main/data/my_dataset.rds) and copy it into your `data/raw` folder (or load it directly from R as done here):

```{r}
pacman::p_load(tidyverse, here, corrplot, modEvA)
url <- "https://raw.githubusercontent.com/UCLouvain-GEOG/LGEO2185/main/data/03_Geoprojects/occurrence_data.Rds"
tmp <- tempfile(fileext = ".rds")
download.file(url, tmp, mode = "wb")
occurrence_df <- readRDS(tmp)
...
```{r}
# test function
 ROI <- gadm(country = "MEX", level = 0, path = here("data", "raw", "GADM"))
