...
## 1.6 Branching and merging (how collaboration stays safe)
...
```text
<<<<<<< HEAD
text from your current branch (what you had locally)
=======
text from the other branch (what Git tried to merge in)
>>>>>>> feature-xyz
```
...
Open the file and manually edit it so it contains the final correct content you want.
Then delete all conflict markers (`<<<<<<<`, `=======`, `>>>>>>>`) and any duplicate lines you don’t want.

------------------------------------------------------------------------

## 1.6 Issues and Pull Requests (GitHub collaboration model)
...
## 1.7 Clone vs Fork : how you get a project onto your machine
...
Assuming you are using Rstudio, and the git repo is already present on Github, here is a short description of how this would work:
...
**Goal:** create a branch, make a small edit, push, and open a Pull Request (PR) ready to be merged to `main`.
