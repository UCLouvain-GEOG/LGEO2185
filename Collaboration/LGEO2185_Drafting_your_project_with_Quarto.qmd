...
-   **Simple syntax**: Markdown and .Rmd can be learned quickly. A Reminder for Your Future Self All components of your work are clearly documented. You don't have to remember what steps, assumptions, tests were used.
...
## 5 How to create a Quarto File in R and the Quarto file structure
...
### 5.2 The structure of a Quarto File
...
**Don't forget these parameters :** the following options are indispensable if you want to share your work with other people.
...
Then inside Quarto, use the standard Pandoc markdown representation for citations (e.g. `[@lovelace_geocomputation_2025]` will give [@lovelace_geocomputation_2025], and `@lovelace_geocomputation_2025` gives @lovelace_geocomputation_2025). 
At the end, the document will automatically make a bibliography with all your references.
Look [here](https://quarto.org/docs/authoring/citations.html ) for more information.
